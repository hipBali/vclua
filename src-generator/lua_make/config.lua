-- **************************************************** --
--                                                      --
-- VCLua 1.0 Class source generator CONFIG              --
--                                                      --
...
classes = {
	...
	{ name = "Strings", src = "TStrings", classparent="TStrings", nocreate=true },
	{ name = "StringList", src = "TStringList", nv=true, noparent=true },
	...
	{ name = "Form", src = "TCustomForm", ref = "Forms, LCLType, LMessages, Controls, Graphics, LuaBitmap" },                                      

	{ name = "Frame", src = "TFrame", ref = "Forms, Controls" },
	{ name = "ScrollBox", src = "TScrollBox", ref = "Forms, Controls" },
	-- actions
	...
	-- standard controls
	{ name = "ListBox", src = "TCustomListBox", ref = "StdCtrls, Controls"},
	...
	{ name = "Label", src = "TCustomLabel", ref = "StdCtrls, Controls" },
	-- ext controls
	...
	{ name = "Shape", src = "TShape", ref = "ExtCtrls, Controls" },
	{ name = "Splitter", src = "TCustomSplitter", ref = "ExtCtrls, Controls, LuaControl" },
	{ name = "PaintBox", src = "TPaintBox", ref = "ExtCtrls, Controls" },
	{ name = "Image", src = "TCustomImage", ref = "ExtCtrls, Controls" },
	...
	{ name = "Panel", src = "TCustomPanel", ref = "ExtCtrls, Controls" },
	{ name = "TrayIcon", src = "TCustomTrayIcon", ref = "ExtCtrls, Controls", noparent=true },
	-- com controls
	...
	{ unit = "ToolBar", ref = "ComCtrls, Controls, ImgList, LuaImageList",
		classes = {
			{ name = "ToolButton", src = "TToolButton", noparent=true,},
			{ name = "ToolBar", src = "TToolBar" },
		}
	},
	{ name = "CoolBar", src = "TCustomCoolBar", ref = "ComCtrls, Controls" },
	...
	{ unit = "TreeView", ref = "ComCtrls, Controls",
		classes = {
	...
	{ unit = "ListView", ref = "ComCtrls, Controls",
		classes = {
