...
begin
	...
	TLuaMethodInfo.Create(CustomTrayIconSets, 'BalloonHint', @VCLua_TrayIcon_VCLuaSetBalloonHint, mfCall, TypeInfo(string));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'BalloonTimeout', @VCLua_TrayIcon_VCLuaSetBalloonTimeout, mfCall, TypeInfo(Integer));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'BalloonTitle', @VCLua_TrayIcon_VCLuaSetBalloonTitle, mfCall, TypeInfo(string));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'PopUpMenu', @VCLua_TrayIcon_VCLuaSetPopUpMenu, mfCall, TypeInfo(TPopupMenu));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'Icon', @VCLua_TrayIcon_VCLuaSetIcon, mfCall, TypeInfo(TIcon));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'Icons', @VCLua_TrayIcon_VCLuaSetIcons, mfCall, TypeInfo(TCustomImageList));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'Hint', @VCLua_TrayIcon_VCLuaSetHint, mfCall, TypeInfo(string));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'ShowIcon', @VCLua_TrayIcon_VCLuaSetShowIcon, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'Visible', @VCLua_TrayIcon_VCLuaSetVisible, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'OnClick', @VCLua_TrayIcon_VCLuaSetOnClick, mfCall, TypeInfo(TNotifyEvent));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'OnDblClick', @VCLua_TrayIcon_VCLuaSetOnDblClick, mfCall, TypeInfo(TNotifyEvent));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'OnMouseDown', @VCLua_TrayIcon_VCLuaSetOnMouseDown, mfCall, TypeInfo(TMouseEvent));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'OnMouseUp', @VCLua_TrayIcon_VCLuaSetOnMouseUp, mfCall, TypeInfo(TMouseEvent));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'OnMouseMove', @VCLua_TrayIcon_VCLuaSetOnMouseMove, mfCall, TypeInfo(TMouseMoveEvent));
	TLuaMethodInfo.Create(CustomTrayIconSets, 'OnPaint', @VCLua_TrayIcon_VCLuaSetOnPaint, mfCall, TypeInfo(TNotifyEvent));
end.
