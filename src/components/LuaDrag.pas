...
begin
	...
	TLuaMethodInfo.Create(DragObjectSets, 'AlwaysShowDragImages', @VCLua_DragObject_VCLuaSetAlwaysShowDragImages, mfCall);
	TLuaMethodInfo.Create(DragObjectSets, 'DragPos', @VCLua_DragObject_VCLuaSetDragPos, mfCall);
	TLuaMethodInfo.Create(DragObjectSets, 'DragTarget', @VCLua_DragObject_VCLuaSetDragTarget, mfCall);
	TLuaMethodInfo.Create(DragObjectSets, 'DragTargetPos', @VCLua_DragObject_VCLuaSetDragTargetPos, mfCall);
	...
	TLuaMethodInfo.Create(DragDockObjectSets, 'DockOffset', @VCLua_DragDockObject_VCLuaSetDockOffset, mfCall);
	TLuaMethodInfo.Create(DragDockObjectSets, 'Floating', @VCLua_DragDockObject_VCLuaSetFloating, mfCall);
	TLuaMethodInfo.Create(DragDockObjectSets, 'EraseDockRect', @VCLua_DragDockObject_VCLuaSetEraseDockRect, mfCall);
	...
	TLuaMethodInfo.Create(DockZoneSets, 'Height', @VCLua_DockZone_VCLuaSetHeight, mfCall);
	TLuaMethodInfo.Create(DockZoneSets, 'Left', @VCLua_DockZone_VCLuaSetLeft, mfCall);
	TLuaMethodInfo.Create(DockZoneSets, 'Orientation', @VCLua_DockZone_VCLuaSetOrientation, mfCall);
	TLuaMethodInfo.Create(DockZoneSets, 'Top', @VCLua_DockZone_VCLuaSetTop, mfCall);
	TLuaMethodInfo.Create(DockZoneSets, 'Width', @VCLua_DockZone_VCLuaSetWidth, mfCall);
	...
	TLuaMethodInfo.Create(DockTreeSets, 'DockSite', @VCLua_DockTree_VCLuaSetDockSite, mfCall);
end.
