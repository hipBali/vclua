...
begin
	...
	TLuaMethodInfo.Create(CustomCoolBarSets, 'BandBorderStyle', @VCLua_CoolBar_VCLuaSetBandBorderStyle, mfCall, TypeInfo(TBorderStyle));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'BandMaximize', @VCLua_CoolBar_VCLuaSetBandMaximize, mfCall, TypeInfo(TCoolBandMaximize));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'Bitmap', @VCLua_CoolBar_VCLuaSetBitmap, mfCall, TypeInfo(TBitmap));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'FixedSize', @VCLua_CoolBar_VCLuaSetFixedSize, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'FixedOrder', @VCLua_CoolBar_VCLuaSetFixedOrder, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'GrabStyle', @VCLua_CoolBar_VCLuaSetGrabStyle, mfCall, TypeInfo(TGrabStyle));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'GrabWidth', @VCLua_CoolBar_VCLuaSetGrabWidth, mfCall, TypeInfo(Integer));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'HorizontalSpacing', @VCLua_CoolBar_VCLuaSetHorizontalSpacing, mfCall, TypeInfo(Integer));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'Images', @VCLua_CoolBar_VCLuaSetImages, mfCall, TypeInfo(TCustomImageList));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'ImagesWidth', @VCLua_CoolBar_VCLuaSetImagesWidth, mfCall, TypeInfo(Integer));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'ShowText', @VCLua_CoolBar_VCLuaSetShowText, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'Themed', @VCLua_CoolBar_VCLuaSetThemed, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'Vertical', @VCLua_CoolBar_VCLuaSetVertical, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'VerticalSpacing', @VCLua_CoolBar_VCLuaSetVerticalSpacing, mfCall, TypeInfo(Integer));
	TLuaMethodInfo.Create(CustomCoolBarSets, 'OnChange', @VCLua_CoolBar_VCLuaSetOnChange, mfCall, TypeInfo(TNotifyEvent));
end.
