...
begin
	SetLength(CustomGridFuncs, 46+1);
	...
	CustomGridFuncs[45].name:='SelectedRange';
	CustomGridFuncs[45].func:=@VCLua_CustomGrid_SelectedRange;
	CustomGridFuncs[46].name:=nil;
	CustomGridFuncs[46].func:=nil;
