...
begin
	CheckArg(L, 1, 2);
	lCustomGrid := TLuaCustomGrid(CheckLuaObjectPop(L, 1));
...
begin
	...
	TLuaMethodInfo.Create(CustomGridSets, 'OnAfterSelection', @VCLua_CustomGrid_VCLuaSetOnAfterSelection, mfCall, TypeInfo(TOnSelectEvent));
	TLuaMethodInfo.Create(CustomGridSets, 'OnBeforeSelection', @VCLua_CustomGrid_VCLuaSetOnBeforeSelection, mfCall, TypeInfo(TOnSelectEvent));
	TLuaMethodInfo.Create(CustomGridSets, 'OnCheckboxToggled', @VCLua_CustomGrid_VCLuaSetOnCheckboxToggled, mfCall, TypeInfo(TToggledCheckboxEvent));
	...
	TLuaMethodInfo.Create(CustomGridSets, 'OnSelectEditor', @VCLua_CustomGrid_VCLuaSetOnSelectEditor, mfCall, TypeInfo(TSelectEditorEvent));
	TLuaMethodInfo.Create(CustomGridSets, 'OnTopLeftChanged', @VCLua_CustomGrid_VCLuaSetOnTopLeftChanged, mfCall, TypeInfo(TNotifyEvent));
	TLuaMethodInfo.Create(CustomGridSets, 'OnUserCheckboxBitmap', @VCLua_CustomGrid_VCLuaSetOnUserCheckboxBitmap, mfCall, TypeInfo(TUserCheckboxBitmapEvent));
	TLuaMethodInfo.Create(CustomGridSets, 'OnUserCheckboxImage', @VCLua_CustomGrid_VCLuaSetOnUserCheckboxImage, mfCall, TypeInfo(TUserCheckBoxImageEvent));
	TLuaMethodInfo.Create(CustomGridSets, 'OnValidateEntry', @VCLua_CustomGrid_VCLuaSetOnValidateEntry, mfCall, TypeInfo(TValidateEntryEvent));
	TLuaMethodInfo.Create(CustomGridSets, 'OnGetCellHint', @VCLua_CustomGrid_VCLuaSetOnGetCellHint, mfCall, TypeInfo(TGetCellHintEvent));
	TLuaMethodInfo.Create(CustomGridSets, 'SortOrder', @VCLua_CustomGrid_VCLuaSetSortOrder, mfCall, TypeInfo(TSortOrder));
	...
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnGetCheckboxState', @VCLua_DrawGrid_VCLuaSetOnGetCheckboxState, mfCall, TypeInfo(TGetCheckboxStateEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnSetCheckboxState', @VCLua_DrawGrid_VCLuaSetOnSetCheckboxState, mfCall, TypeInfo(TSetCheckboxStateEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnColRowDeleted', @VCLua_DrawGrid_VCLuaSetOnColRowDeleted, mfCall, TypeInfo(TgridOperationEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnColRowExchanged', @VCLua_DrawGrid_VCLuaSetOnColRowExchanged, mfCall, TypeInfo(TgridOperationEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnColRowInserted', @VCLua_DrawGrid_VCLuaSetOnColRowInserted, mfCall, TypeInfo(TGridOperationEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnColRowMoved', @VCLua_DrawGrid_VCLuaSetOnColRowMoved, mfCall, TypeInfo(TgridOperationEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnGetEditMask', @VCLua_DrawGrid_VCLuaSetOnGetEditMask, mfCall, TypeInfo(TGetEditEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnGetEditText', @VCLua_DrawGrid_VCLuaSetOnGetEditText, mfCall, TypeInfo(TGetEditEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnHeaderClick', @VCLua_DrawGrid_VCLuaSetOnHeaderClick, mfCall, TypeInfo(THdrEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnHeaderSized', @VCLua_DrawGrid_VCLuaSetOnHeaderSized, mfCall, TypeInfo(THdrEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnHeaderSizing', @VCLua_DrawGrid_VCLuaSetOnHeaderSizing, mfCall, TypeInfo(THeaderSizingEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnSelectCell', @VCLua_DrawGrid_VCLuaSetOnSelectCell, mfCall, TypeInfo(TOnSelectCellEvent));
	TLuaMethodInfo.Create(CustomDrawGridSets, 'OnSetEditText', @VCLua_DrawGrid_VCLuaSetOnSetEditText, mfCall, TypeInfo(TSetEditEvent));
end.
