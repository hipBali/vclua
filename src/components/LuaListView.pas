...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListItem', 'SetData', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListItem', 'SetPosition', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListItem', 'GetPosition', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListItems', 'GetFlags', E.ClassName, E.Message);
	end;
	lua_push(L,ret,TypeInfo(ret));
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListItems', 'SetCount', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListItems', 'GetCount', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListItems', 'GetOwner', E.ClassName, E.Message);
	end;
	lua_push(L,ret,TypeInfo(ret));
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetBoundingRect', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetCanvas', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetCheckboxes', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetCheckboxes', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetColumnCount', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetDropTarget', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetDropTarget', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetFlatScrollBars', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetFlatScrollBars', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetFullDrag', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetFullDrag', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetGridLines', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetGridLines', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetHotTrack', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetHotTrack', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetHotTrackStyles', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetHotTrackStyles', E.ClassName, E.Message);
	end;
	lua_push(L,ret,TypeInfo(ret));
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetIconOptions', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetIconOptions', E.ClassName, E.Message);
	end;
	lua_push(L,ret,TypeInfo(ret));
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetItemFocused', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetItemFocused', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetItemIndex', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetItemIndex', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetItems', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetItems', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetMultiSelect', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetMultiSelect', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetOwnerData', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetOwnerData', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetReadOnly', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetReadOnly', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetRowSelect', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetRowSelect', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetSelCount', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetSelected', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetSelected', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetLastSelected', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetTopItem', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'SetViewOrigin', E.ClassName, E.Message);
	end;
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetViewOrigin', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	try
		...
		on E: Exception do
			CallError(L, 'ListView', 'GetVisibleRowCount', E.ClassName, E.Message);
	end;
	lua_push(L,ret);
end;
...
begin
	...
	TLuaMethodInfo.Create(CustomListViewSets, 'OnChange', @VCLua_ListView_VCLuaSetOnChange, mfCall, TypeInfo(TLVChangeEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnColumnClick', @VCLua_ListView_VCLuaSetOnColumnClick, mfCall, TypeInfo(TLVColumnClickEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnCompare', @VCLua_ListView_VCLuaSetOnCompare, mfCall, TypeInfo(TLVCompareEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnData', @VCLua_ListView_VCLuaSetOnData, mfCall, TypeInfo(TLVDataEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnDataFind', @VCLua_ListView_VCLuaSetOnDataFind, mfCall, TypeInfo(TLVDataFindEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnDataHint', @VCLua_ListView_VCLuaSetOnDataHint, mfCall, TypeInfo(TLVDataHintEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnDataStateChange', @VCLua_ListView_VCLuaSetOnDataStateChange, mfCall, TypeInfo(TLVDataStateChangeEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnDeletion', @VCLua_ListView_VCLuaSetOnDeletion, mfCall, TypeInfo(TLVDeletedEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnEdited', @VCLua_ListView_VCLuaSetOnEdited, mfCall, TypeInfo(TLVEditedEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnEditing', @VCLua_ListView_VCLuaSetOnEditing, mfCall, TypeInfo(TLVEditingEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnInsert', @VCLua_ListView_VCLuaSetOnInsert, mfCall, TypeInfo(TLVInsertEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnItemChecked', @VCLua_ListView_VCLuaSetOnItemChecked, mfCall, TypeInfo(TLVCheckedItemEvent));
	TLuaMethodInfo.Create(CustomListViewSets, 'OnSelectItem', @VCLua_ListView_VCLuaSetOnSelectItem, mfCall, TypeInfo(TLVSelectItemEvent));
	...
	TLuaMethodInfo.Create(CustomListViewSets, 'Checkboxes', @VCLua_ListView_VCLuaSetCheckboxes, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'DropTarget', @VCLua_ListView_VCLuaSetDropTarget, mfCall, TypeInfo(TListItem));
	TLuaMethodInfo.Create(CustomListViewSets, 'FlatScrollBars', @VCLua_ListView_VCLuaSetFlatScrollBars, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'FullDrag', @VCLua_ListView_VCLuaSetFullDrag, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'GridLines', @VCLua_ListView_VCLuaSetGridLines, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'HotTrack', @VCLua_ListView_VCLuaSetHotTrack, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'HotTrackStyles', @VCLua_ListView_VCLuaSetHotTrackStyles, mfCall, TypeInfo(TListHotTrackStyles));
	TLuaMethodInfo.Create(CustomListViewSets, 'IconOptions', @VCLua_ListView_VCLuaSetIconOptions, mfCall, TypeInfo(TIconOptions));
	TLuaMethodInfo.Create(CustomListViewSets, 'ItemFocused', @VCLua_ListView_VCLuaSetItemFocused, mfCall, TypeInfo(TListItem));
	TLuaMethodInfo.Create(CustomListViewSets, 'ItemIndex', @VCLua_ListView_VCLuaSetItemIndex, mfCall, TypeInfo(Integer));
	TLuaMethodInfo.Create(CustomListViewSets, 'Items', @VCLua_ListView_VCLuaSetItems, mfCall, TypeInfo(TListItems));
	TLuaMethodInfo.Create(CustomListViewSets, 'MultiSelect', @VCLua_ListView_VCLuaSetMultiSelect, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'OwnerData', @VCLua_ListView_VCLuaSetOwnerData, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'ReadOnly', @VCLua_ListView_VCLuaSetReadOnly, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'RowSelect', @VCLua_ListView_VCLuaSetRowSelect, mfCall, TypeInfo(Boolean));
	TLuaMethodInfo.Create(CustomListViewSets, 'Selected', @VCLua_ListView_VCLuaSetSelected, mfCall, TypeInfo(TListItem));
	TLuaMethodInfo.Create(CustomListViewSets, 'ViewOrigin', @VCLua_ListView_VCLuaSetViewOrigin, mfCall, TypeInfo(TPoint));
end.
